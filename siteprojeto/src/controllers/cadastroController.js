...
function entrar(req, res) {
    ...
    if (email == undefined) {
        ...
        cadastroModel.entrar(email, senha)
            .then(
                function (resultado) {
...
function cadastrar(req, res) {
    ...
    // Faça as validações dos valores
     if (email == undefined) {
        ...
        res.status(400).send("Sua nomeCompleto está undefined!");
        ...
        cadastroModel.cadastrar(apelido, email, senha, nomeCompleto, dtNasc, celular)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
